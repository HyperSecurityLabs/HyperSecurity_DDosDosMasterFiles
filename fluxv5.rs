// Network load testing tool for authorized security testing
// Simulates realistic traffic patterns with various device types and behaviors
// Version: 8.20.2026v5
...
#[command(about = "Network load testing tool for authorized security testing")]
struct CliArgs {
...
/// Displays animated diagonal cyber-style banner
/// Displays a clean ASCII banner with version and warning information
fn display_banner() {
    // Clear screen for clean display
    print!("\x1B[2J\x1B[1;1H");
    io::stdout().flush().unwrap();
    
    // Static ASCII banner - clean and professional
    println!("\x1B[1;36m");
    println!("    ███████╗██╗     ██╗   ██╗██╗  ██╗");
    println!("    ██╔════╝██║     ██║   ██║╚██╗██╔╝");
    println!("    █████╗  ██║     ██║   ██║ ╚███╔╝ ");
    ...
    println!("\x1B[0m");
    println!();
    println!("\x1B[1;33m    [*] Network Load Testing Tool v8.20.2026v5\x1B[0m");
    println!("\x1B[1;31m    [!] For Authorized Security Testing Only\x1B[0m");
    println!("\x1B[1;32m    [+] Advanced Traffic Simulation Engine\x1B[0m");
    println!();
